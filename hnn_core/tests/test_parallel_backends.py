...
def run_duecker_model():
    """Run the Duecker model and return the dipole and network objects (requires MPI)

    This function was taken from `script_duecker_simulate_save.py`

    Network setup and drive config were taken from
    ...
    # ONLY returning the FIRST dipole
    return dpls[0], net
